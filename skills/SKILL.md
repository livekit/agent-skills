...
This skill provides behavioral guidance for building voice AI agents with LiveKit. It encodes *how to approach* LiveKit development, not API specifics. All factual information about APIs, methods, and configurations must come from live documentation.
